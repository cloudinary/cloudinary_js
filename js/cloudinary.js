...
;
  ...
  CloudinaryConfiguration = (function() {
    var DEFAULT_CONFIGURATION_PARAMS, DEFAULT_POSTER_OPTIONS, DEFAULT_VIDEO_SOURCE_TYPES, ref;
  ...
  Transformation = (function(superClass) {
    ...
    Transformation.prototype.flatten = function() {
      ...
      transformation_string = _.filter(transformation_string, function(value) {
      ...
      return _.compact(result_array).join('/');
    };
  ...
  Cloudinary = (function() {
    ...
    cloudinary_url = function(public_id, options) {
      ...
      if (public_id.search('/') >= 0 && !public_id.match(/^v[0-9]+/) && !public_id.match(/^https?:\//) && !((ref = options.version) != null ? ref.toString() : void 0)) {
        options.version = 1;
      }
  ...
  HtmlTag = (function() {
    function HtmlTag(name, public_id, options) {
      ...
      this.cloudinary = Cloudinary(options);
      this._transformation = new Transformation(options);
    }
  ...
  VideoTag = (function(superClass) {
    ...
    function VideoTag(public_id1, options) {
      ...
      VideoTag.__super__.constructor.call(this, "video", this.public_id, {});
