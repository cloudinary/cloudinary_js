...
(function() {
  module.exports = function(grunt) {
          ...
          files: [
            {
              expand: true,
              flatten: true,
              src: ["bower_components/blueimp-canvas-to-blob/js/canvas-to-blob.min.js", "bower_components/blueimp-file-upload/js/jquery.fileupload-image.js", "bower_components/blueimp-file-upload/js/jquery.fileupload-process.js", "bower_components/blueimp-file-upload/js/jquery.fileupload-validate.js", "bower_components/blueimp-file-upload/js/jquery.fileupload.js", "bower_components/blueimp-file-upload/js/jquery.iframe-transport.js", "bower_components/blueimp-file-upload/js/vendor/jquery.ui.widget.js"],
              dest: "js/"
            }, {
    ...
    return grunt.registerTask('build', ['coffee', 'requirejs', 'jsdoc:amd', 'copy:file-upload', 'uglify']);
  };
