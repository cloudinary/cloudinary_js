 ...
 * @internal
 */
var Transformation, TransformationBase, m;
...
TransformationBase = (function() {
  ...
  class TransformationBase {
    ...
    constructor(options = {}) {
       ...
       */
      this.toOptions || (this.toOptions = function(withChain = true) {
      ...
      /** @protected */
      this.rawParam || (this.rawParam = function(value, name, abbr, defaultValue, process = identity) {
        process = lastArgCallback(arguments);
        trans[name] = new RawParam(name, abbr, process).set(value);
        return this;
      });
      /** @protected */
      this.rangeParam || (this.rangeParam = function(value, name, abbr, defaultValue, process = identity) {
        process = lastArgCallback(arguments);
        trans[name] = new RangeParam(name, abbr, process).set(value);
        return this;
      });
      /** @protected */
      this.arrayParam || (this.arrayParam = function(value, name, abbr, sep = ":", defaultValue = [], process = identity) {
        process = lastArgCallback(arguments);
        trans[name] = new ArrayParam(name, abbr, sep, process).set(value);
        return this;
      });
      /** @protected */
      this.transformationParam || (this.transformationParam = function(value, name, abbr, sep = ".", defaultValue, process = identity) {
        process = lastArgCallback(arguments);
 ...
 */
export default Transformation = class Transformation extends TransformationBase {
  /**
 ...
 * Values are camelCased.
 */
Transformation.methods || (Transformation.methods = difference(functions(Transformation.prototype), functions(TransformationBase.prototype)));
