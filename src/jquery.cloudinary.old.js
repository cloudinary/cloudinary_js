...
(function (factory) {
  ...
  function process_base_transformations(options) { //Done
    ...
    if (all_named) {
      return []; // options.transformation is a string or array of strings or null/undefined, create as t_{}.{}.{}
    }
  ...
  function process_size(options) { // Done
  ...
  function process_html_dimensions(options) { // Done
  ...
  var TRANSFORMATION_PARAM_VALUE_MAPPING = { // Done
  ...
  function generate_transformation_string(options) {
    var base_transformations = process_base_transformations(options); // handle options.transformation
