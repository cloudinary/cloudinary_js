describe("cloudinary", function() {
  ...
  it("should disallow url_suffix in shared distribution", function() {
    expect(function(){window.cloudinary.url_internal("test", {url_suffix: "hello", private_cdn: false})}).toThrow();
  });

  it("should disallow url_suffix in non upload types", function() {
    expect(function(){window.cloudinary.url_internal("test", {url_suffix: "hello", private_cdn: true, type: "facebook"})}).toThrow();
  });

  it("should disallow url_suffix with / or .", function() {
    expect(function(){window.cloudinary.url_internal("test", {url_suffix: "hello/world", private_cdn: true})}).toThrow();
    expect(function(){window.cloudinary.url_internal("test", {url_suffix: "hello.world", private_cdn: true})}).toThrow();
  });
  ...
  it("should disallow use_root_path if not image/upload", function() {
    expect(function(){window.cloudinary.url_internal("test", {use_root_path: true, private_cdn: true, type: "facebook"})}).toThrow();
    expect(function(){window.cloudinary.url_internal("test", {use_root_path: true, private_cdn: true, resource_type: "raw"})}).toThrow();
  });
