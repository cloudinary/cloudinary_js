(function() {
  describe('cloudinary', function() {
    var fixtureContainer, layer, layers, protocol, result, test_cloudinary_url;
    result = void 0;
    ...
    it('should use width and height from options only if crop is given', function() {
      test_cloudinary_url('test', {
        width: 100,
        height: 100
      }, protocol + '//res.cloudinary.com/test123/image/upload/test', {
        html_width: 100,
        html_height: 100
      });
      return test_cloudinary_url('test', {
        ...
        height: 100,
        crop: 'crop'
      }, protocol + '//res.cloudinary.com/test123/image/upload/c_crop,h_100,w_100/test', {
        html_width: 100,
        html_height: 100
      });
    });
    ...
    it('should support base tranformation', function() {
      return test_cloudinary_url('test', {
        ...
        crop: 'crop',
        width: 100
      }, protocol + '//res.cloudinary.com/test123/image/upload/c_fill,x_100,y_100/c_crop,w_100/test', {
        html_width: 100
      });
    });
    it('should support array of base tranformations', function() {
      return test_cloudinary_url('test', {
        ...
        crop: 'crop',
        width: 100
      }, protocol + '//res.cloudinary.com/test123/image/upload/c_fill,w_200,x_100,y_100/r_10/c_crop,w_100/test', {
        html_width: 100
      });
    });
    it('should not include empty tranformations', function() {
      ...
      }, protocol + '//res.cloudinary.com/test123/image/upload/c_fill,x_100,y_100/test', {});
    });
