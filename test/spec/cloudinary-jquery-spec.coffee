describe 'cloudinary', ->
  ...
  it 'should support base tranformation', ->
    test_cloudinary_url 'test', {
      ...
      crop: 'crop'
      width: 100
    }, protocol + '//res.cloudinary.com/test123/image/upload/c_fill,x_100,y_100/c_crop,w_100/test', html_width: 100
  ...
  it 'should support array of base tranformations', ->
    test_cloudinary_url 'test', {
      ...
      crop: 'crop'
      width: 100
    }, protocol + '//res.cloudinary.com/test123/image/upload/c_fill,w_200,x_100,y_100/r_10/c_crop,w_100/test', html_width: 100
