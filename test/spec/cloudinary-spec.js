(function() {
  describe('cloudinary', function() {
    var layer, layers, test_cloudinary_url;
    ...
    beforeEach(function() {
      return window.cloudinary = new Cloudinary({
        cloud_name: 'test123'
      });
    });
    afterEach(function() {});
    ...
    it('should use width and height from options only if crop is given', function() {
      ...
      return expect(cloudinary.url('test', {
        width: 100,
        height: 100,
        crop: 'crop'
    ...
    describe('window.devicePixelRatio', function() {
      ...
      it('should update dpr when creating an image tag using $.cloudinary.image()', function() {
        ...
        return expect(getAttribute(result, 'src')).toBe(window.location.protocol + '//res.cloudinary.com/test123/image/upload/dpr_2.0/test');
      });
    ...
    it('should disallow url_suffix in shared distribution', function() {
      return expect(function() {
        return window.cloudinary.url('test', {
          url_suffix: 'hello',
          private_cdn: false
        });
      }).toThrow();
    ...
    it('should support globally set use_root_path for private_cdn', function() {
      ...
      return delete window.cloudinary.config().use_root_path;
    });
    ...
    it('should compute stoppoints correctly', function() {
      ...
      return expect(window.cloudinary.calc_stoppoint(el, 100)).toEqual(140);
    });
